...
/**
 * Decorate the start date of date range.
 */
public class CalendarRangeStartDecorator implements DayViewDecorator {

    private final HashSet<CalendarDay> list = new HashSet<>();
    private final Drawable drawable;
    private final int color;

    public CalendarRangeStartDecorator(final Context context) {
        drawable = context.getResources().getDrawable(R.drawable.calendar_range_start_selector);
     ...
     */
    public void setDateRangeStartDate(final CalendarDay start) {
        list.clear();
        list.add(start);
    }
